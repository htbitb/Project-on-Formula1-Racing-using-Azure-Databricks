...
After ingesting all the data from ADLS raw data file into processed data file, we continue to transform them follow the requirement

![](/source/formula1_ergast_db_data_model.png)
