...
blobContainerName = "presentation"
mountPoint = "/mnt/data/presentation"
...
dbutils.fs.ls("/mnt/data/raw/")

# COMMAND ----------

dbutils.fs.unmount("/mnt/data/presentation")

# COMMAND ----------

display(spark.read.csv("/mnt/data/processed", header=True))